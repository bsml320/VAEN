...
# Below is necessary for starting Numpy generated random numbers
# in a well-defined initial state.

np.random.seed(int(sys.argv[1]))

# Below is necessary for starting core Python generated random numbers
# in a well-defined state.

rn.seed(int(sys.argv[1]))

# tf.set_random_seed() will make random number generation
...
work_dir = sys.argv[2]          ### /work/Z01.ReLU/
train_file_path = sys.argv[3]   ### CCLE.4VAE.Z01.tsv
val_file_1_path = sys.argv[4]   ### TCGA.4VAE.Z01.tsv
train_latent_file = sys.argv[5] ### CCLE.latent.tsv
train_weight_file = sys.argv[6] ### CCLE.weight.tsv
val_1_pred_file = sys.argv[7]   ### TCGA.latent.tsv
encoder_file = sys.argv[8]      ### encoder.hdf5
decoder_file = sys.argv[9]      ### decoder.hdf5
...
### results will be generated in the result folder
