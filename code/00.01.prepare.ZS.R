...
##########################################################################
write.table(scaled.ccle.train.mat, file=paste("/work/ZS/CCLE.4VAE.ZS.tsv", sep=""), row.names=T, quote=F, sep="\t")
write.table(scaled.RPKM.mat, file=paste("/work/ZS/TCGA.4VAE.ZS.tsv", sep=""), row.names=T, quote=F, sep="\t")
##########################################################################
