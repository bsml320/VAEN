...
gdsc.pred      = read.table(file="/work/result.EN/dr.GDSC/01/F1-W5-PCC/F1-W5-PCC.avgtop10.pred_GDSC.txt", header=T, as.is=T, sep="\t")
gdsc.pred.full = read.table(file="/work/result.EN/dr.GDSC/01/F1-W5-PCC/F1-W5-PCC.avgtop10.pred_GDSC.full.txt", header=T, as.is=T, sep="\t")
...
########################################################################################################################
predicted.dr = read.table(paste("/work/result.EN/dr.GDSC/01/GDSC.MIX-F1-W5-PCC.avgtop10.pred_TCGA.txt", sep=""), header=T, as.is=T, sep="\t")
