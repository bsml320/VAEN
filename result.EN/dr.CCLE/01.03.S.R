...
for(ksigmoid in 1:100){
	fn = paste("/path/to/VAEN/result.EN/dr.CCLE/01S/", ksigmoid, ".CCLE.model.list.S.RData", sep="")
	if(!file.exists(fn))next
	load(paste("/path/to/VAEN/result.EN/dr.CCLE/01S/", ksigmoid, ".CCLE.model.list.S.RData", sep=""))
