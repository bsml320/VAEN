...
###########################################################################################################
	...
	original.TCGA.RPKM = read.delim(paste("/work/data/TCGA/",cur.cancer,"/HiSeqV2", sep=""), as.is=T)
...
####### after finish, put all files in the folder: /work/result.EN/dr.CCLE/04-mix/09.Expr/W5/